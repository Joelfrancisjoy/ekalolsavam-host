...
from .serializers import (
    ...
    SentimentAnalyticsQuerySerializer,
    SentimentAnalyticsResponseSerializer,
...
@extend_schema(
    methods=['GET'],
    parameters=[SentimentAnalyticsQuerySerializer],
    responses={
        200: SentimentAnalyticsResponseSerializer,
...
def sentiment_analytics(request):
    ...
    if user.role != 'admin':
        message = "Only admins can view sentiment analytics"
        return Response(
    ...
    try:
        ...
        # Keep current runtime behavior while preserving existing API contract.
        _ = days
        ...
        message = f"Failed to generate sentiment analytics: {str(e)}"
        return Response(
            {"error": message, "detail": message},
...
@extend_schema(
    ...
    responses={
        200: AnalyzeTextResponseSerializer,
